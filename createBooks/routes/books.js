...
router.get('/', function(req, res) {
    let books = [
        ...
        {id: 8, name: 'Catcher in the Rye', author: ' J.D. Salinger', pages: 116, available: 'true'},
        {id: 9, name: 'Anne of Green Gables', author: 'L. M. Montgomery', pages: 382, available: 'true'},
        {id: 10, name: 'Twenty Thousand Leagues Under the Sea', author: 'Jules Verne', pages: 259, available: 'true'}
